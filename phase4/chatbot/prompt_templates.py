...
2. After your answer, add a blank line, then this single line:
     Last updated: <scraped_at>  Source: <source_url>
   Both must appear on the same line. No other domains except indmoney.com.
